...
<body background="images/pic8.jpg">
 ...
 %><input type="button" name="logout" value="Logout"
			style="border-radius: 12px; background-color: black; color: white; border-width: 5px; border-color: transparent">
		</a>
	</div>
	</nav> </section>
	...
	<div
		style="color: white; background: black; background-image: inherit; font-size: 20px">
		<%
			String s = request.getParameter("feedID");
			String que = "select * from feedback where feedID='" + s + "' and status='pending'";
			try {
				...
				if (rst.next() == false) {
					out.println("<script type=\"text/javascript\">");
					   out.println("alert('Incorrect Feedback ID');");
					   out.println("location='viewFeedback.jsp';");
					   out.println("</script>");
				} else {
					out.print("<center>Feedback ID : " + rst.getString(1) + "</center><br>");
					...
					session.setAttribute("feedID", rst.getString(1));
				}
				//}
			} catch (Exception e) {
				e.printStackTrace();
		...
		<center>
			<b>
				<form action="statusFeedback.jsp" method=get style="color: white">
					Accept Feedback&nbsp;&nbsp;<input type="radio" name="r1"
						value="accept" required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Reject Feedback&nbsp;&nbsp;<input type="radio" name="r1"
						value="reject" required><br> <br> <input
						type="submit" value="submit" name="b1"
						style="font-size: 20px; border-width: 7px; border-color: transparent; border-radius: 12px; background-color: black; color: white">
				</form>
			</b>
		</center>
	</div>
