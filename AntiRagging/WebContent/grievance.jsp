	...
	<section id="feedback">
		<div class="container">
			<div class="feedback text-center ">
				<form method="get" action=insertGrievanceServlet>
					<h1>Grievance</h1>
					<br>
					<%
						try {
					...
					%>
					<textarea cols="100" rows="5" name="grievance"
						placeholder="Enter The Grievance" required></textarea>
					<br><br> <input type="submit" value="submit"
						style="color: black; background-color: skyblue; border-color: transparent; border-radius: 12px; width: 80px; height: 40px; font-size: 20px">
				</form>
			</div>
		</div>
	</section>
